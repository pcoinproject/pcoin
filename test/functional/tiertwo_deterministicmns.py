...
class DIP3Test(PcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 PCOIN) to the operator, and (2 * 2.7 PCOIN) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid PCOIN address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid PCOIN address InvalidPayee", controller.protx_update_registrar,
