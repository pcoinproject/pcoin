#!/usr/bin/env python3
# Copyright (c) 2020 The PCOIN Core developers
...
class SaplingMempoolTest(PcoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 PCOIN note to Alice
        ...
        # miner sends another 10 PCOIN note to Alice
