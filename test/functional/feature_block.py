...
# Copyright (c) 2020-2021 The PCOIN developers
...
class FullBlockTest(PcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure pcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure pcoind isn't accepting b28
        ...
        # PCOIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the pcoin code has custom code which does so);
