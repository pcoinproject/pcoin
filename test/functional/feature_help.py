...
"""Verify that starting pcoin with -h works as expected."""
...
class HelpTest(PcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pcoin with -? for help text")
        ...
        self.log.info("Start pcoin with -version for version information")
