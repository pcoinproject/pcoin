...
class NetTest(PcoinTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 22501)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 22501)
