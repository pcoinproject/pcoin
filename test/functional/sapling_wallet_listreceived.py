...
class ListReceivedTest (PcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 PCOIN.
        ...
        # Send 1 PCOIN to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 PCOIN sending them all (fee is 0.1 PCOIN)
        ...
        # Confirm transaction (2 PCOIN from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 PCOIN, send 0.6 PCOIN + 0.05 PCOIN fee
