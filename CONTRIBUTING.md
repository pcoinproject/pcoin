Contributing to PCOIN Core
============================

The PCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PCOIN Core project, and is not to be
confused with overall PCOIN Network Protocol consensus changes.

Whether a pull request is merged into PCOIN Core rests with the project merge
...
Patches that change PCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the PCOIN consensus, it must have been
...
The project leader is the release manager for each PCOIN Core release.
