...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("pcoin"), "Pcoin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://pcoin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/pcoin"));
    BOOST_CHECK(validateURL("https://foo.bar/pcoin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.pcoin.com"));
