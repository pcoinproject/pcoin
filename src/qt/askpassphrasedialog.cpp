...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            PCOINGUI* window = static_cast<PCOINGUI*>(parentWidget());
...
{
    PCOINGUI* gui = static_cast<PCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<PCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your PCOINs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
