...
/** Utility functions used by the PCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render PCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZpcoin = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZpcoin = false);
...
// Parse "pcoin:" URI into recipient object, return true on successful parsing
