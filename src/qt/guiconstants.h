...
// Copyright (c) 2015-2018 The PCOIN developers
...
/* Pcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_DOMAIN "pcoin.dev"
#define QAPP_APP_NAME_DEFAULT "PCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "PCOIN-Qt-testnet"
