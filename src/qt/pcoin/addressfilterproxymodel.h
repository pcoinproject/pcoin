...
#ifndef PCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define PCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //PCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
