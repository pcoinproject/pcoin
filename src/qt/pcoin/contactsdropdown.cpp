...
#include "qt/pcoin/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, PCOINGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
