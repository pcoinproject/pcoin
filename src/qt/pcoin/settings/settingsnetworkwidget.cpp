...
#include "qt/pcoin/settings/settingsnetworkwidget.h"
#include "qt/pcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/pcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PCOINGUI* _window, QWidget *parent) :
