...
#include "qt/pcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/pcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PCOINGUI* _window, QWidget *parent) :
