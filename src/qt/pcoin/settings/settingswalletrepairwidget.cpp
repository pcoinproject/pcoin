...
#include "qt/pcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/pcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PCOINGUI::handleRestart()
