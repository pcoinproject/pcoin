                             ...
                             QString& ret_error)
{
    ...
    QString strConfFileQt(PCOIN_MASTERNODE_CONF_FILENAME);
    ...
    if (lineCopy.empty()) {
        lineCopy = "# Masternode config file\n"
                   ...
                   "# Example: mn1 127.0.0.2:22501 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0"
                   "#";
    }
    lineCopy += "\n";
