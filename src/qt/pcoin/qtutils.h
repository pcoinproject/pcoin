...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PCOINGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, PCOINGUI* gui, double posX = 3);
