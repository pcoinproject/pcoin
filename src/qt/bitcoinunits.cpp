...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case PCOIN:
        return QString("pcoin");
    case mPCOIN:
        return QString("mpcoin");
    case uPCOIN:
        return QString::fromUtf8("upcoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZpcoin)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPCOIN)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZPCOIN);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPCOIN)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZPCOIN));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
