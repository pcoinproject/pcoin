...
#error Client version information missing: version is not defined by pcoin-config.h or in any other way
#endif
...
/**
 * pcoind-res.rc includes this file, but it cannot cope with real c++ code.
